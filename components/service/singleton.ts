...
export class NzSingletonService {
  ...
  private constructor() {}
  private static instance: NzSingletonService;
  static getInstance() {
    if (!NzSingletonService.instance) {
      NzSingletonService.instance = new NzSingletonService();
    }
    return NzSingletonService.instance;
  }
}
